...
public class ColdAndHotPublisherTest {
    ...
    @Test
    public void coldPublisherTest() throws InterruptedException { // Pega os dados do começo
...
//        Thread.sleep(4000);
    ...
    @Test
    public void hotPublisherTest() throws InterruptedException { //FAz a continuação dos dados
        Flux<String> stringFlux = Flux.just("A", "B", "C", "D", "E", "F")
                .delayElements(Duration.ofSeconds(1));
